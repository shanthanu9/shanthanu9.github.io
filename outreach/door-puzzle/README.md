...
Imagine 30 doors in a row, numbered **1** to **30**. At the start every door is *closed*.  
Then you follow this routine:
...
## TODOs
- Make the puzzle to responsive to most screen sizes.
- Add option to edit total number of doors.
- Add option to pause/play the "flip doors" animation.